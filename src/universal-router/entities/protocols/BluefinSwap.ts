...
export interface BluefinProtocolConfig {
  wrappedRouterPackageId: string;
  globalConfigObjectId: string;
}

export interface BluefinSwapSwapOptions<
  CInput extends Coin,
  COutput extends Coin
> extends SwapConstructorOptions<CInput, COutput, BluefinProtocolConfig> {
  xForY: boolean;
...
export class BluefinSwap<
  CInput extends Coin,
  COutput extends Coin
> extends Swap<
  CInput,
  COutput,
  BluefinProtocolConfig,
  BluefinSwapSwapOptions<CInput, COutput>
> {
  ...
  constructor(options: BluefinSwapSwapOptions<CInput, COutput>) {
    super(options);
