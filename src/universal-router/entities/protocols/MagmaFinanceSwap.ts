...
export interface MagmaFinanceProtocolConfig {
  wrappedRouterPackageId: string;
  globalConfigObjectId: string;
}
export interface MagmaFinanceSwapOptions<
  CInput extends Coin,
  COutput extends Coin
> extends SwapConstructorOptions<CInput, COutput, MagmaFinanceProtocolConfig> {
  xForY: boolean;
...
export class MagmaFinanceSwap<
  CInput extends Coin,
  COutput extends Coin
> extends Swap<
  CInput,
  COutput,
  MagmaFinanceProtocolConfig,
  MagmaFinanceSwapOptions<CInput, COutput>
> {
  ...
  constructor(options: MagmaFinanceSwapOptions<CInput, COutput>) {
    super(options);
